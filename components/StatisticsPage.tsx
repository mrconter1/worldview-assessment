...
const QUESTIONS = [
  ...
  "People refuse to accept that things take time and therefore prioritize shortcuts like gambling, extreme training, and risk-taking. The slow path feels intolerable, which is why people often begin new habits like exercise or learning a new language with an unsustainable intensity that leads to burnout. People seek quick solutions even when they're less likely to work because gradual progress feels like no progress.",
